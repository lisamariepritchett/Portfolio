...
This package contains supporting data and MATLAB code for:
     ...
     Pritchett, L. M., & Murray, R. F. (2015).  Classification images reveal decision strategies in forced choice tasks.  Proceedings of the National Academy of Sciences of the U.S.A., X(Y), xx-yy.

This package can be downloaded from http://purl.org/NET/rfm/pnas2015.
...
The directory 'tools' contains routines that are used by the top-level scripts that generate the figures.
